#!/usr/bin/env node
/**
 * readiness-check — verify Clix Mobile is PRODUCTION READY.
 *
...
const APP_ID = "com.clix.mobile";
const SITE = "https://bolajiev.github.io/clix-mobile";
const FDROID_INDEX = `${SITE}/fdroid/repo/index-v1.json`;
const RELEASES = "https://github.com/bolajiev/clix-mobile/releases/latest";
...
console.log(c("1", "Clix Mobile — Production Readiness Check"));
...
if (!has("gh")) {
  ...
  const r = spawnSync("gh", ["repo", "view", "bolajiev/clix-mobile", "--json", "repositoryTopics,homepageUrl"], { encoding: "utf8" });
  try {
