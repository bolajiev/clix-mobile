...
```bash
git clone https://github.com/bolajiev/clix-mobile.git
cd clix-mobile
...
Use the [Bug Report template](https://github.com/bolajiev/clix-mobile/issues/new?template=bug_report.md).
...
Use the [Feature Request template](https://github.com/bolajiev/clix-mobile/issues/new?template=feature_request.md) or start a [GitHub Discussion](https://github.com/bolajiev/clix-mobile/discussions) if you want to explore the idea before opening a formal issue.
...
5. Open the PR against `bolajiev/clix-mobile main`. Fill in the PR template.
...
- You grant YOUR_ORG_NAME and the project's users a perpetual, worldwide, royalty-free license under the MIT License terms.
...
This project follows the [Contributor Covenant Code of Conduct](CODE_OF_CONDUCT.md). Please treat everyone with respect. Report issues to [support@bolajiev.com](mailto:support@bolajiev.com).
