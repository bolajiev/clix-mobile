...
Google Play rejected `com.clix.mobile` on 2026-07-22 because the app's Data Safety
...
`src/lib/waitlist.ts` → `POST https://`) collects an
...
4. Confirm the **Privacy policy URL** field still points at
   `https://bolajiev.github.io/clix-mobile/privacy/` (now updated with the email
