# Clix Mobile — Ownership Context

App: `com.clix.mobile` (Clix Mobile). Expo/React Native Android client
for a user self-hosted opencode AI coding server. Owner: YOUR_ORG_NAME.
...
- DISCOVERY: self-hosted F-Droid repo is ALREADY LIVE at
  https://bolajiev.github.io/clix-mobile/fdroid/repo (index 200), but STALE —
  serving old package com.clix.mobile @ v0.4.1. publish-fdroid succeeded for
...
- Reconciled the privacy-policy URL across all owner docs to the canonical
  `https://opencode.vibebrowser.app/privacy` (was split with bolajiev.com in 3 spots;
...
- **F-Droid v0.4.3 is now LIVE** (the big open gap). Publish run 26808062042 on the
  ...
  {'com.clix.mobile': ['0.4.3']} (was stale com.clix.mobile 0.4.1 all prior
