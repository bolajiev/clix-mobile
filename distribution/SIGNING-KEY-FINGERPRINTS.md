# Signing Key Fingerprints — clix-mobile
...
Key alias: (see Bitwarden item `KEYSTORE_INFO` in project folder `clix-mobile`)
...
The keystore is gitignored. Backup location: Bitwarden project folder `clix-mobile`,
