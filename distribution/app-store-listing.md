...
• Multiple connection types — local network (Wi-Fi), secure tunnels (Cloudflare Tunnel, ngrok), or cloud-hosted opencode instances• Real-time streaming chat — watch your AI agent think and respond live as it works through your code
...
Clix Mobile is MIT licensed. Source code, issue tracker, and community discussion:
https://github.com/bolajiev/clix-mobile

PRIVACY

Clix Mobile does not collect your code, prompts, or AI responses. All AI traffic goes directly from the app to YOUR opencode server — never through our infrastructure. We use Sentry for crash reporting only (no personally identifiable information, no message content). See our privacy policy for full details.
...
If you cannot self-host, contact support@bolajiev.com and we will provide a temporary review endpoint.

SUPPORT

Email: support@bolajiev.com
Issues: https://github.com/bolajiev/clix-mobile/issues
```
...
| Field | Value |
|---|---|
| Support URL | https://opencode.bolajiev.com |
| Marketing URL | https://github.com/bolajiev/clix-mobile |
| Privacy Policy URL | https://bolajiev.github.io/clix-mobile/privacy/ |
...
Apple uses a questionnaire to assign an age rating. Answer as follows for Clix Mobile:
...
Clix Mobile does NOT collect any of the following:
...
**App Tracking Transparency (ATT)**: Clix Mobile does **not** use the ATT framework (`AppTrackingTransparency`) and does **not** access the IDFA (Identifier for Advertisers). No ad networks or cross-app tracking SDKs are present. No ATT permission prompt is shown to users.
...
```
Clix Mobile requires the reviewer to connect to an opencode server.

OPTION A — We provide a hosted review endpoint:
Contact support@bolajiev.com before the review window and we will email a temporary server URL valid for 72 hours.
...
This is an early beta. Please report issues via the TestFlight feedback button or email support@bolajiev.com.
...
- [ ] Apple Developer Program enrollment approved (D-U-N-S 142059652, YOUR_ORG_NAME LLC)
- [ ] App Store Connect app record created (bundle ID: com.clix.mobile)
