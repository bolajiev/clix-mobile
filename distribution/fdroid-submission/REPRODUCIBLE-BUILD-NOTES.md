# Reproducible Build Notes — com.clix.mobile
...
```
While analysing /home/azureuser/workspace/clix-mobile/node_modules/...
```
...
# Full build test
fdroid build com.clix.mobile:<versionCode> --verbose
```
...
`fdroid build com.clix.mobile:<versionCode> --verbose` (or the fdroiddata
