# Apple Developer Program Enrollment Runbook — YOUR_ORG_NAME
...
| Field | Value | Source |
|---|---|---|
| Legal Entity Name | YOUR_ORG_NAME | WA LLC registration |
...
| Primary Contact Email | YOUR_GOOGLE_ACCOUNT_EMAIL | |
...
**DECIDED 2026-05-24, REVISED 2026-07-17 (owner)**: Use `YOUR_GOOGLE_ACCOUNT_EMAIL` — same Google account as the Play Console, keeping store operations on one identity.

- If no Apple ID exists yet for `YOUR_GOOGLE_ACCOUNT_EMAIL`: create at https://appleid.apple.com/account
...
| Prompt | Enter |
|---|---|
| Legal Entity Name | `YOUR_ORG_NAME` |
...
- [x] Write/publish privacy policy at https://bolajiev.github.io/clix-mobile/privacy/
...
1. Create a new App in App Store Connect:
   ...
   - Bundle ID: `com.clix.mobile` — register this explicit App ID first at https://developer.apple.com/account/resources/identifiers/
   - SKU: `com.clix.mobile` (can match bundle ID)
