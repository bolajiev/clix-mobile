...
## App submission: Clix Mobile

**App name:** Clix Mobile
**Package / App ID:** `com.clix.mobile`
**License:** MIT
**Source code:** https://github.com/bolajiev/clix-mobile
**GitHub releases:** https://github.com/bolajiev/clix-mobile/releases
...
```
https://github.com/bolajiev/clix-mobile/releases/download/<TAG>/app-release.apk
```

Example (first production release):
```
https://github.com/bolajiev/clix-mobile/releases/download/v0.4.2/app-release.apk
```
...
Clix Mobile is a free, open-source (MIT) client for the opencode AI coding
...
reviewing proposed code changes before accepting them, multi-session management,from the app to the user's own server — no middleman, no mandatory accounts, no
...
- Source code is fully public: https://github.com/bolajiev/clix-mobile
- License: MIT (https://github.com/bolajiev/clix-mobile/blob/main/LICENSE
...
Developer: YOUR_ORG_NAME
Email: support@bolajiev.com
Website: https://opencode.bolajiev.com
Privacy policy: https://bolajiev.github.io/clix-mobile/privacy/
