...
Step-by-step guide to file the inclusion request for `com.clix.mobile`
...
- [ ] Signed release APK (not AAB) exists and is attached to a GitHub tag
      (e.g. `https://github.com/bolajiev/clix-mobile/releases/tag/v0.4.2`)
...
- [ ] Privacy policy is live at `https://bolajiev.github.io/clix-mobile/privacy/`
...
# Expected:
#   package: name='com.clix.mobile' versionCode='<N>' versionName='<X.Y.Z>'
...
2. Click "New Issue"
3. Title: `Include com.clix.mobile (Clix Mobile)`
...
- When mainline F-Droid MR is later accepted, comment on this issue:
  "Mainline F-Droid has accepted com.clix.mobile — please auto-delist per policy."
...
- IzzyOnDroid repo (for badge URLs): https://apt.izzysoft.de/fdroid/index/apk/com.clix.mobile
