...
- Self-hosted F-Droid repo is live at https://bolajiev.github.io/clix-mobile/fdroid/repo (used in all drafts). Optional: file an upstream fdroiddata MR for inclusion in the main F-Droid catalog once the Sentry opt-in gate is merged
