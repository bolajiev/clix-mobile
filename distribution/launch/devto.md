...
Install: add the self-hosted F-Droid repo `https://bolajiev.github.io/clix-mobile/fdroid/repo` in your F-Droid client, or grab the [direct APK](https://github.com/bolajiev/clix-mobile/releases/latest). Google Play is in internal testing and coming soon.
Landing page and docs: [https://bolajiev.github.io/clix-mobile/](https://bolajiev.github.io/clix-mobile/)
