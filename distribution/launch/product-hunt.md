...
Clix Mobile is the Android client for [opencode](https://github.com/sst/opencode) — the open-source AI coding agent. Connect to your own opencode server over local Wi-Fi, Cloudflare Tunnel, Tailscale, or ngrok, and control AI-powered coding sessions from anywhere.
...
**Links:**
- Get it (all install options): https://bolajiev.github.io/clix-mobile/
- F-Droid repo (add in your F-Droid client): https://bolajiev.github.io/clix-mobile/fdroid/repo
...
- MIT licensed. Source is public at https://github.com/bolajiev/clix-mobile. F-Droid submission in progress.
