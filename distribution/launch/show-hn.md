# Show HN: Clix Mobile – Android client for the opencode AI coding agent

**Title:** Show HN: Clix Mobile – drive your self-hosted AI coding agent from your phone
...
Landing page (all install options): https://bolajiev.github.io/clix-mobile/
