# Play Store ASO Listing — Clix Mobile
...
```
Clix Mobile is the AI coding agent companion built for developers who self-host opencode. Connect your Android phone to your opencode server and run AI-powered coding sessions from anywhere — watch diffs land, approve tool calls, and guide Claude, GPT, Gemini, or any other model you configure in real time.
...
<b>PRIVACY</b>
Clix Mobile does not collect your code, prompts, or AI responses. All traffic goes directly from the app to YOUR opencode server — never through our infrastructure. Optional Sentry crash reporting collects only device model, OS version, and stack traces (no message content).

Support: support@bolajiev.com
Issues: github.com/bolajiev/clix-mobile/issues
Source: github.com/bolajiev/clix-mobile
```
