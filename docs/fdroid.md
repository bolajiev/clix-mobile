# F-Droid + IzzyOnDroid — clix-mobile

Operational doc for distributing `com.clix.mobile` via F-Droid (mainline)
and IzzyOnDroid under YOUR_ORG_NAME.
...
3. Create `metadata/com.clix.mobile.yml` from `distribution/fdroid-submission/metadata.yml`.
...
- App on IzzyOnDroid (after acceptance): https://apt.izzysoft.de/fdroid/index/apk/com.clix.mobile
