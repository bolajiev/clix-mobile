# Go-to-Market + Pricing — clix-mobile

YOUR_ORG_NAME · app `com.clix.mobile` · MIT licensed · 2026-05-24.
...
GitHub Sponsors profile under YOUR_ORG_NAME org.

| Tier | Price | Perk |
|---|---|---|
| Supporter | $5/mo | Name in `SUPPORTERS.md` |
| Backer | $15/mo | Name + early access to Cloud beta + private Discord channel |
| Business | $50/mo | Company logo on bolajiev.com/opencode footer + 30-min support call once per quarter |
...
**Action**: enable GitHub Sponsors on the YOUR_ORG_NAME GitHub org. Link from README + Play/App Store listing.
...
- [ ] bolajiev.com/opencode subdomain live (agent working)
...
- Hacker News "Show HN: Clix Mobile — open-source mobile client for the opencode AI coding agent" launch post on Monday morning Pacific.
...
- Blog post on bolajiev.com/opencode: "Building Clix Mobile in 12 weeks."
...
| 2026-05-24 | Apple ID = support@bolajiev.com (not Gmail) | Apple recommends domain-matched email for org accounts |
...
| 2026-05-24 | `bolajiev.com/opencode` subdomain (not path) | Cleaner URLs, separate Vercel project, dedicated landing |
...
3. Should we offer the LLC's "YOUR_ORG_NAME" branding for the cloud product, or rebrand opencode Cloud under a sub-brand? **Recommendation**: rebrand "opencode Cloud" as a sub-product. Keep the LLC name backstage.
...
4. ⏸ Domain `bolajiev.com/opencode` live with landing + /privacy + /terms — agent running
5. ⏸ Write "How we're funded" page at bolajiev.com/opencode/funding — covers free vs paid breakdown
