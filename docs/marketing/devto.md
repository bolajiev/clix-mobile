...
cover_image: https://bolajiev.github.io/clix-mobile/play-graphics/feature-graphic.png
canonical_url: https://bolajiev.github.io/clix-mobile/
---
...
So I built Clix Mobile.

## What it is

Clix Mobile is a React Native / Expo Android app. It's a thin client for the opencode HTTP + SSE API — no backend of mine between your phone and your server.
...
MIT licensed. Source at [github.com/bolajiev/clix-mobile](https://github.com/bolajiev/clix-mobile). Issues and PRs welcome.

Install ([all options on one page](https://bolajiev.github.io/clix-mobile/download/)): add the self-hosted F-Droid repo `https://bolajiev.github.io/clix-mobile/fdroid/repo` in your F-Droid client, or grab the [direct APK](https://github.com/bolajiev/clix-mobile/releases/latest). Google Play is in review and going live shortly: {{PLAY_URL}}

Landing page and setup guide: [bolajiev.github.io/clix-mobile](https://bolajiev.github.io/clix-mobile/)
