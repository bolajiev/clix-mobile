...
> `{{PLAY_URL}}` = `https://play.google.com/store/apps/details?id=com.clix.mobile` once approved (PH lets you add the Play link as a product link on the day it goes live).
...
- Website (primary): https://bolajiev.github.io/clix-mobile/
- Install (F-Droid + APK, one page): https://bolajiev.github.io/clix-mobile/download/
- GitHub: https://github.com/bolajiev/clix-mobile
- F-Droid repo: https://bolajiev.github.io/clix-mobile/fdroid/repo
...
Clix Mobile is the Android client for [opencode](https://github.com/sst/opencode) — the open-source AI coding agent. Connect to your own opencode server over local Wi-Fi, Tailscale, Cloudflare Tunnel, or ngrok, and control AI-powered coding sessions from anywhere.
...
Hey Product Hunt! I'm the developer of Clix Mobile.
