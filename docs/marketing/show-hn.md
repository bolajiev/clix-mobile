...
> `{{PLAY_URL}}` = swap in `https://play.google.com/store/apps/details?id=com.clix.mobile` on the day Play approval lands. Until then, leave the Play line exactly as written below.
...
```
Show HN: Clix Mobile – drive your self-hosted AI coding agent from your phone
```

**URL field:** `https://github.com/bolajiev/clix-mobile`
...
opencode (sst/opencode, MIT) is a terminal-based AI coding agent — you run it on your laptop or a server, it talks to Claude / GPT / Gemini / local models via your own API keys, and it writes, edits, and runs code through tool calls. Clix Mobile is a thin HTTP + SSE client that connects to that server process. From your phone you can:
...
- Source: https://github.com/bolajiev/clix-mobile
- Install (F-Droid + APK, one page): https://bolajiev.github.io/clix-mobile/download/
- Landing page: https://bolajiev.github.io/clix-mobile/
- Setup guide: https://bolajiev.github.io/clix-mobile/guide/
- F-Droid repo (add this URL in an F-Droid client): https://bolajiev.github.io/clix-mobile/fdroid/repo
- Direct APK: https://github.com/bolajiev/clix-mobile/releases/latest
