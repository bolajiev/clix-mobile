...
1. Open https://appstoreconnect.apple.com/ and sign in with `support@bolajiev.com`
...
1. Open https://developer.apple.com/account/ and sign in with `support@bolajiev.com`
...
| Field | Value | Notes |
|---|---|---|
| `appleId` | `support@bolajiev.com` | The Apple ID used for App Store Connect login — update if different |
