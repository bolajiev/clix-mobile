...
Required env vars:
  ...
  PACKAGE_NAME                 — Android package (com.clix.mobile)
...
REPO = os.environ.get("GITHUB_REPOSITORY", "bolajiev/clix-mobile")
PACKAGE_NAME = os.environ.get("PACKAGE_NAME", "com.clix.mobile")
