        ...
        <View style={s.pathRow}>
          <TouchableOpacity onPress={goUp} disabled={!canGoUp} hitSlop={8} testID="directory-up-button">
            <Ionicons
              ...
              size={22}
              color={canGoUp ? theme.accentDeep : isDark ? "#3a3a3a" : "#dddddd"}
            />
          </TouchableOpacity>
          ...
          {roots.map((root) => (
            ...
            >
              <Ionicons
                ...
                size={14}
                color={browseDir === root.path ? "#ffffff" : theme.accentDeep}
              />
              <Text
                style={[
                  s.rootChipText,
...
const s = StyleSheet.create({
  ...
  rootChipActive: { backgroundColor: "#D97757" },
  rootChipText: {
    fontSize: 12,
    fontWeight: "600",
    color: "#BC5F3E",
  },
  rootChipTextDark: { color: "#E59274" },
