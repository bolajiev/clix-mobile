      ...
      <View style={s.header}>
        ...
        {shortCurrent && (
          <View style={s.current}>
            <Ionicons name="folder" size={14} color="#D97757" />
      ...
      {(serverHome || onBrowse) && (
        <View style={s.chips}>
          ...
          {onBrowse && (
            ...
            >
              <Ionicons name="folder-open-outline" size={14} color={isDark ? "#D97757" : "#BC5F3E"} />
          ...
          >
            <View style={s.rowIcon}>
              <Ionicons
                ...
                size={20}
                color={item.active ? "#D97757" : isDark ? "#888888" : "#666666"}
              />
            </View>
            ...
            {item.active && <Ionicons name="checkmark-circle" size={20} color="#D97757" />}
          </TouchableOpacity>
        )}
...
const s = StyleSheet.create({
  ...
  rowActive: { backgroundColor: "#F3E3D8" },
  rowIcon: { width: 28, alignItems: "center" },
  rowContent: { flex: 1 },
  rowLabel: { fontSize: 15, fontWeight: "500", color: "#0a0a0a" },
  rowLabelActive: { color: "#D97757" },
