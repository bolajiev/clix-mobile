...
export const metadata: Metadata = {
  title: 'Documentation',
  description:
    'Clix Mobile documentation. Quick start guide, API reference, and self-hosting instructions.',
  alternates: { canonical: 'https://clix.bolajiev.com/docs' },
  openGraph: {
    title: 'Documentation | Clix Mobile',
    description: 'Clix Mobile docs — coming soon. See README on GitHub for now.',
    url: 'https://clix.bolajiev.com/docs',
  },
}
...
const quickLinks = [
  {
    ...
    href: 'https://github.com/bolajiev/clix-mobile#readme',
    external: true,
  },
  {
    title: 'Releases',
    description: 'Download APKs and view changelog for every release.',
    href: 'https://github.com/bolajiev/clix-mobile/releases',
    external: true,
  },
  {
    title: 'Bug Reports',
    description: 'Found a bug? Open an issue on GitHub.',
    href: 'https://github.com/bolajiev/clix-mobile/issues/new',
    external: true,
  },
  {
    title: 'Contributing',
    description: 'Want to contribute? See CONTRIBUTING.md in the repo.',
    href: 'https://github.com/bolajiev/clix-mobile/blob/main/CONTRIBUTING.md',
    external: true,
  },
]
  ...
  return (
    <div className="max-w-3xl mx-auto px-4 sm:px-6 py-16">
      ...
      <div className="rounded-xl p-6 text-center" style={{ background: 'rgba(59,130,246,0.08)', border: '1px solid rgba(59,130,246,0.25)' }}>
        ...
        <a
          href="https://github.com/bolajiev/clix-mobile/discussions"
          target="_blank"
