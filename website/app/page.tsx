...
export const metadata: Metadata = {
  title: 'Clix Mobile — The open source AI coding agent, on the go',
  description:
  ...
  alternates: { canonical: 'https://clix.bolajiev.com' },
}
      ...
      <section className="pt-24 pb-20 md:pt-36 md:pb-28">
        <div className="max-w-5xl mx-auto px-4 sm:px-6">
          ...
          <div className="flex flex-wrap gap-3 mb-4">
            <a
              href="https://play.google.com/store/apps/details?id=com.clix.mobile"
              target="_blank"
            ...
            <a
              href="https://bolajiev.github.io/clix-mobile/fdroid/repo"
              target="_blank"
              rel="noopener noreferrer"
              className="btn-secondary text-sm"
            >
      ...
      <section className="py-20 border-t" style={{ borderColor: 'var(--border)' }}>
        <div className="max-w-5xl mx-auto px-4 sm:px-6">
          <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-8">
            ...
            <a
              href="https://github.com/bolajiev/clix-mobile"
              target="_blank"
              rel="noopener noreferrer"
