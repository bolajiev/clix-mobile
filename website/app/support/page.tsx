...
export const metadata: Metadata = {
  title: 'Support',
  description:
    'Get help with Clix Mobile. Contact us, browse GitHub Issues, and read the FAQ.',
  alternates: { canonical: 'https://clix.bolajiev.com/support' },
  openGraph: {
    title: 'Support | Clix Mobile',
    description: 'Contact, FAQ, and GitHub Issues for Clix Mobile.',
    url: 'https://clix.bolajiev.com/support',
  },
}
...
const faqs = [
  ...
  },
  {
    ...
    a: `No. All AI traffic — your prompts, code, diffs, and AI responses — travels directly between the app and your own opencode server. YOUR_ORG_NAME never sees this data. The only optional data we receive is anonymous crash diagnostics via Sentry, and only if you opt in at first launch.`,
  },
  {
    q: 'Can I self-host the backend?',
    a: `Yes — that's the primary use case. Clix Mobile is a client for the open-source opencode server (github.com/sst/opencode). You run the server wherever you like: your laptop, a VPS, a home server, or a cloud VM. The app simply connects to whatever URL you configure.`,
  },
  {
  ...
  },
  {
    ...
    a: `Please open a GitHub Issue at github.com/bolajiev/clix-mobile/issues with: your device model, Android/iOS version, app version (Settings → About), and a description of what happened. If you opted in to crash reporting, we may already have the stack trace — your issue report helps us match it to the right bug.`,
  },
]
  ...
  return (
    <div className="max-w-3xl mx-auto px-4 sm:px-6 py-16">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-5 mb-16">
        <a
          href="mailto:support@bolajiev.com"
        ...
        >
          ...
          <div>
            ...
            <p className="text-sm" style={{ color: 'var(--muted)' }}>support@bolajiev.com</p>
          </div>
        </a>

        <a
          href="https://github.com/bolajiev/clix-mobile/issues"
          target="_blank"
      ...
      <div className="mt-12 p-5 rounded-xl text-sm" style={{ background: 'rgba(59,130,246,0.08)', border: '1px solid rgba(59,130,246,0.25)', color: 'var(--muted)' }}>
        Still stuck? Open a{' '}
        <a href="https://github.com/bolajiev/clix-mobile/issues/new" target="_blank"
          rel="noopener noreferrer" style={{ color: 'var(--accent)' }}>
          GitHub Issue
        </a>{' '}
        or email{' '}
        <a href="mailto:support@bolajiev.com" style={{ color: 'var(--accent)' }}>
          support@bolajiev.com
        </a>.
