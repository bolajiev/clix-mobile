      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 flex items-center justify-between h-16">
        ...
        <div className="hidden md:flex items-center gap-6">
          {[
            ...
            { href: 'https://github.com/bolajiev/clix-mobile', label: 'GitHub', external: true },
      ...
      {open && (
        <div className="md:hidden border-t px-4 py-4 space-y-3" style={{ borderColor: 'var(--border)', backgroundColor: 'var(--bg)' }}>
          {[
            ...
            { href: 'https://play.google.com/store/apps/details?id=com.clix.mobile', label: 'Download', external: true },
          ].map((link) => (
            <Link
              key={link.href}
              href={link.href}
